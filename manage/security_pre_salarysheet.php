...
$th = array(_("SL"), _("Name"), _("Card NO"),"Join AB","Left AB", "Work Day", "Leave", "Absent", "Overtime", "OT<<2", "Cutting", "Rate","Attendance Bonus","Salary","Extra Add","Extra Cut");
...
while ($myrow = db_fetch($Emp_Presal)) {
	alt_table_row_color($k);
		...
		input_num_td_wl('attn_bonus_'.$myrow["emp_id"],$myrow["attn_bonus"],true);
		input_num_td_wl('salary_'.$myrow["emp_id"],$myrow["salary"],true);
