...
page(_($help_context = "Department"));
...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM') {
	...
	if(strlen($_POST['name']) == 0 || $_POST['name'] == '' || strlen($_POST['name_bd']) == 0 || $_POST['name_bd'] == '' ) {
		...
		write_department($selected_id, $_POST['name'], $_POST['name_bd']);
...
$th = array(_("Deparment Id"), _("Department Name"), _("Department Name (Bangla)"), "", "");
...
if($selected_id != '') {
 	...
 	if ($Mode == 'Edit') {
		...
		$_POST['name_bd']  = $myrow["dept_name_bd"];
		hidden('selected_id', $myrow['dept_id']);
 	}
}

text_row_ex(_("Department Name:"), 'name', 50, 60);
text_row_ex(_("Department Name(Bangla):"), 'name_bd', 50, 60);
